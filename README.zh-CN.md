...
一个受到 `ex-skill` 启发的 BPD 风格人格技能模板，支持人格层、记忆层、纠正层和录入工作流，适合角色扮演、对话写作、关系模式分析和人物蒸馏。

English version: [README.md](README.md)

## 这是什么

`bpd-skill` 是一个可复用的技能模板，用来模拟一种：
...
- [persona.zh-CN.md](persona.zh-CN.md)：稳定依恋方式、受伤逻辑和升级路径
